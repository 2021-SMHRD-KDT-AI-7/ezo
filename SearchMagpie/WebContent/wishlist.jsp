...
<link rel="stylesheet" href="./css/wish_list2.css" />
		...
		<div class="basketdiv" id="basket">
			...
			<div class="row data">
				<div class="subdiv">
					...
					<div class="img">
						<img src="./images/wish1.jpg" width="60">
					</div>
					<div class="pname">
						<span>삼성전자 214cm Neo QLED 8K KQ85QNA900FXKR [벽걸이형]</span>
					</div>
				</div>
				<div class="subdiv">
					<div class="basketprice">
						<input type="hidden" name="p_price" id="p_price1" class="p_price"
							value="20000">20,455,000원
					</div>
					<div class="num">
						<div class="updown">
			...
			<div class="row data">
				<div class="subdiv">
					...
					<div class="img">
						<img src="./images/wish2.jpg" width="60">
					</div>
					<div class="pname">
						<span>XBOX One X 블랙 한국정발 밀봉 새제품</span>
					</div>
				</div>
				<div class="subdiv">
					<div class="basketprice">
						<input type="hidden" name="p_price" id="p_price2" class="p_price"
							value="19000">645,000원
					</div>
					<div class="num">
						<div class="updown">
			...
			<div class="row data">
				<div class="subdiv">
					...
					<div class="img">
						<img src="./images/wish3.jpg" width="60">
					</div>
					<div class="pname">
						<span>iPad Air</span>
					</div>
