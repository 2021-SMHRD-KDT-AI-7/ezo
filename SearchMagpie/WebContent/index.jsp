				...
				<div class="row">
					<div class="col-sm-12">
						<div class="custom_menu">
							<ul>
								<li><a href="#">직구! 하나부터 열까지!</a></li>
								<li><a href="#">asdf</a></li>
								<li><a href="#">adsfasdfasdfasdf</a></li>
								<li><a href="#"> <i class="fa fa-shopping-cart"
										aria-hidden="true"></i> <span class="padding_10">록인하고싶은뎅</span></a>
								</li>
								<li><a href="login_resist_form.html"> <i
										class="fa fa-user" aria-hidden="true"></i> <span
										class="padding_10">로그인</span></a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="containt_main">
					<div id="mySidenav" class="sidenav">
						...
						<a href="index.html">Home</a> <a href="fashion.html">TV</a> <a
							href="electronic.html">전자담배</a> <a href="jewellery.html">태블릿</a>
					</div>
