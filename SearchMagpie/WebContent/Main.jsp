...
<body>
		...
		<div class="header_section">
			<div class="container">
				<div id="mySidenav" class="sidenav">
						...
						<a href="fashion.html">TV</a>
						<a href="electronic.html">전자담배</a>
						<a href="jewellery.html">태블릿</a>
				</div>
					...
					<div class="header_box">
						...
						<div class="login_menu">
							<ul>
								...
								<li><a href="login_resist_form.html"> 
		...
		<div class="banner_section layout_padding">
			<div class="container">
				<div id="my_slider" class="carousel slide" data-ride="carousel">
					...
					</a> <a class="carousel-control-next" href="#my_slider" role="button" data-slide="next"> 
	...
	<div class="fashion_section">
		<div id="electronic_main_slider" class="carousel slide"
			...
			<a class="carousel-control-prev" href="#electronic_main_slider" role="button" data-slide="prev"> 
				<i class="fa fa-angle-left"></i>
			</a> <a class="carousel-control-next" href="#electronic_main_slider" role="button" data-slide="next"> 
				<i class="fa fa-angle-right"></i>
			</a>
		</div>
	</div>
	...
	<div class="jewellery_section">
		<div id="jewellery_main_slider" class="carousel slide" data-ride="carousel">
			...
			<i class="fa fa-angle-left"></i>
			</a> <a class="carousel-control-next" href="#jewellery_main_slider" role="button" data-slide="next"> 
				<i class="fa fa-angle-right"></i>
			</a>
