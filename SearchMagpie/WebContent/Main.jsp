...
<body>
					...
					<div class="col-sm-12">
						<div class="custom_menu">
							<ul>
								...
								<li><a href="#"><i class="fa fa-book"
										aria-hidden="true"></i>가이드</a></li>
								<li><a href="board_MainFrame.jsp"><i
										class="fa fa-file-signature" aria-hidden="true"></i>게시판</a></li>
								<li><a href="#"><i class="fa fa-bell"
										aria-hidden="true"></i>고객센터</a></li>
								<li><a href="wish.jsp"><i class="fa fa-shopping-cart"
										aria-hidden="true"></i>찜 목록</a></li>
								<li><a href="logoutServiceCon.do"><i class="fa fa-user"
								...
								<li><a href="guide.html"><i class="fa fa-book"
										aria-hidden="true"></i>가이드</a></li>
								<li><a href="board_MainFrame.jsp"><i
										class="fa fa-file-signature" aria-hidden="true"></i>게시판</a></li>
								<li><a href="loginFrame.jsp"><i class="fa fa-user"
										aria-hidden="true"></i>로그인</a></li>
								<li><a href="joinFrame.jsp"><i class="fa fa-bell"
			...
			<div class="container">
				<div class="containt_main">
					<div id="mySidenav" class="sidenav">
						...
						<a href="index.html">메인페이지</a> <a href="fashion.html">가이드</a> <a
							href="electronic.html">게시판</a> <a href="jewellery.html">고객센터</a>
					</div>
					...
					<div class="dropdown">
						<button class="btn btn-secondary dropdown-toggle" type="button"
							...
							aria-haspopup="true" aria-expanded="false">상품 카테고리</button>
						<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
							<a class="dropdown-item" href="#">TV</a> <a class="dropdown-item"
								href="#">Xbox</a> <a class="dropdown-item" href="#">태블릿</a>
						</div>
					</div>
					<div class="main">
	...
	<div class="footer_section layout_padding1">
		<div class="container">
			...
			<div class="input_bt">
				<input type="text" class="mail_bt" placeholder="이메일을 입력하세요"
					name="Your Email"> <span class="subscribe_bt"
					id="basic-addon2"><a href="#">인증메일 보내기</a></span>
			</div>
	...
	<script src="https://kit.fontawesome.com/949677030e.js"
