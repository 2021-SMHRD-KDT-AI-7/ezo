...
<%
	...
	if(temp.size() < 2){
		...
		//이미지 준비중
		data_img_one = "./images/image_none.jpg";
		data_img_two = temp.get(0).getP_file1();
		//데이터 소스
		data_source_one ="";
		data_source_two = temp.get(0).getP_source();
		...
		if(temp.get(0).getP_price()<temp.get(1).getP_price()){
			...
			data_url_two = temp.get(0).getP_url();
			//데이터 소스
			data_source_one = temp.get(1).getP_source();
			data_source_two = temp.get(0).getP_source();
		}
		else{
			...
			//데이터 소스
			data_source_one = temp.get(0).getP_source();
			data_source_two = temp.get(1).getP_source();
		}
					...
					<div class="container">
						...
						<div class="box_main1">							
								<div>
									...
									<p class="price_text"><%=data_source_one%></p>
									<p class="price_text">
								...
								<div class="box_main2 test">
									...
									<p class="price_text"><%=data_source_two%></p>
