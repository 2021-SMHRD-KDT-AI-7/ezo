...
public class productDTO {
	...
	public String toString() {
		return "productDTO [p_key=" + p_key + ", p_name=" + p_name + ", p_price=" + p_price + ", p_view_cnt="
				+ p_view_cnt + ", web_key=" + web_key + ", sold_yn=" + sold_yn + ", reg_date=" + reg_date + ", p_pic1="
				+ p_pic1 + ", p_pic2=" + p_pic2 + ", p_pic3=" + p_pic3 + ", p_pic4=" + p_pic4 + "]";
	}
